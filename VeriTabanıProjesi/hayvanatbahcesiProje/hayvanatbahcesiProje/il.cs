...
namespace hayvanatbahcesiProje
{
    public partial class il : Form
    {
        ...
        public il(NpgsqlConnection connnection)
        {
            InitializeComponent();
            conn = connnection;
        }
        ...
        private void ekle_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand komut = new NpgsqlCommand("insert into il (ilno, ilad) values (@p1, @p2)", conn);
            komut.Parameters.AddWithValue("@p1", int.Parse(ilno.Text));
            komut.Parameters.AddWithValue("@p2", ilad.Text);
        ...
        private void guncelle_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand komut = new NpgsqlCommand("update il set ilad=@p2 where ilno=@p1", conn);
            komut.Parameters.AddWithValue("@p1", int.Parse(ilno.Text));
            komut.Parameters.AddWithValue("@p2", ilad.Text);
            komut.ExecuteNonQuery();
            conn.Close();
        ...
        private void sil_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand komut = new NpgsqlCommand("delete from il where ilno=@p1", conn);
            komut.Parameters.AddWithValue("@p1", int.Parse(ilno.Text));
            komut.ExecuteNonQuery();
            conn.Close();
