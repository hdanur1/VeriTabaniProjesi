...
namespace hayvanatbahcesiProje
{
    ...
    public partial class personel : Form
    {
        ...
        public personel(NpgsqlConnection connnection)
        {
            InitializeComponent();
            conn = connnection;
        }
        ...
        private void ekle_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand komut = new NpgsqlCommand("insert into personel (personelno, ad, soyad, personeltur, maasno) values (@p1, @p2, @p3, @p4, @p5)", conn);
        ...
        private void guncelle_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand komut = new NpgsqlCommand("update personel set ad=@p2,soyad=@p3,personeltur=@p4,maasno=@p5 where personelno=@p1", conn);
            komut.Parameters.AddWithValue("@p1", int.Parse(personelno.Text));
            komut.Parameters.AddWithValue("@p2", ad.Text);
            komut.Parameters.AddWithValue("@p3", soyad.Text);
            komut.Parameters.AddWithValue("@p4", personeltur.Text);
        ...
        private void sil_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand komut = new NpgsqlCommand("delete from personel where personelno=@p1", conn);
            komut.Parameters.AddWithValue("@p1", int.Parse(personelno.Text));
            komut.ExecuteNonQuery();
            conn.Close();
