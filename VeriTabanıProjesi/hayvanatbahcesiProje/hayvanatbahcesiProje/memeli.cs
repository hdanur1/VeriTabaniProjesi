...
{
    public partial class memeli : Form
    {
        NpgsqlConnection conn;
        public memeli(NpgsqlConnection connnection)
        {
            InitializeComponent();
            conn = connnection;
        }
        ...
        {
            string sorgu = "select * from memeli";
        ...
        private void memeli_Load(object sender, EventArgs e)
        {
            listele();
        }
        ...
        private void ekle_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand komut = new NpgsqlCommand("insert into memeli (turno, turad) values (@p1, @p2)", conn);
        ...
        private void guncelle_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand komut = new NpgsqlCommand("update memeli set turad=@p2 where turno=@p1", conn);
            komut.Parameters.AddWithValue("@p1", int.Parse(turno.Text));
            komut.Parameters.AddWithValue("@p2", turad.Text);
            komut.ExecuteNonQuery();
            conn.Close();
        ...
        private void sil_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand komut = new NpgsqlCommand("delete from memeli where turno=@p1", conn);
            komut.Parameters.AddWithValue("@p1", int.Parse(turno.Text));
            komut.ExecuteNonQuery();
            conn.Close();
