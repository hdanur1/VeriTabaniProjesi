...
namespace hayvanatbahcesiProje
{
    public partial class kus : Form
    {
        ...
        public kus(NpgsqlConnection connnection)
        {
            InitializeComponent();
            conn = connnection;
        }
        ...
        private void ekle_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand komut = new NpgsqlCommand("insert into kus (turno, turad) values (@p1, @p2)", conn);
        ...
        private void guncelle_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand komut = new NpgsqlCommand("update kus set turad=@p2 where turno=@p1", conn);
            komut.Parameters.AddWithValue("@p1", int.Parse(turno.Text));
            komut.Parameters.AddWithValue("@p2", turad.Text);
            komut.ExecuteNonQuery();
            conn.Close();
        ...
        private void sil_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand komut = new NpgsqlCommand("delete from kus where turno=@p1", conn);
            komut.Parameters.AddWithValue("@p1", int.Parse(turno.Text));
            komut.ExecuteNonQuery();
            conn.Close();
